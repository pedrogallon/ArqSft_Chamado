...
public class ChamadoDAO {
	...
	/**
	 * 
	 * @param idFila = Fila.id selecionado
...
//		String query = "SELECT ID_CHAMADO, DESCRICAO, STATUS, DT_ABERTURA, DT_FECHAMENTO, ID_FILA FROM servicedesk.chamado WHERE ID_CHAMADO = ?; ";
//		Chamado chamado = new Chamado();
//		try(Connection conn = ConnectionFactory.getConnection();
//			PreparedStatement pst = conn.prepareStatement(query);
//				){
...
//	}
	...
	/**
	 * 
	 * @param chamado = Chamado com descricao e idFila
	 * 			Criação de entrada no banco com descrição, status = aberto, dt_abertura = data atual e idFila
	 * @throws IOException
	 */
	...
	/**
	 * 
	 * @param ids = array de ID's de Chamados a serem fechados
	 * 			Update status = fechado e dt_fechamento = data atual
	 * @throws IOException
	 */
